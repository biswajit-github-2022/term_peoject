...
def main(
    ...
    with tqdm(total=len(content)) as pbar:
        for i,samples in enumerate(content):
            ...
            bbox = [[bb[0],bb[1],bb[0]+bb[2],bb[1]+bb[3]] for bb in bbox]             
            boxx.append(bbox)
            clx.append(label)
            imgs.append(img)
            ...
            gt_bbox,gt_label = gt["bbox"],gt["category"]            gt_bbox = [[bb[0]-bb[2]/2,bb[1]-bb[3]/2,bb[0]+bb[2]/2,bb[1]+bb[3]/2] for bb in gt_bbox] 
